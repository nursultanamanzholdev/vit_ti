...
def vit_12(*args, **kwargs):
    return _vit_lite(num_layers=12, num_heads=3, mlp_ratio=4, embedding_dim=192,
                    *args, **kwargs)


@register_model
def vit_ti_16_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
    return vit_12('vit_ti_16_224', pretrained, progress,
                 kernel_size=16,
...
@register_model
def vit_ti_32_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
    return vit_12('vit_ti_32_224', pretrained, progress,
                 kernel_size=32,
                 img_size=img_size, positional_embedding=positional_embedding,
                 num_classes=num_classes,
                 *args, **kwargs)
...
@register_model
def vit_ti_56_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
    return vit_12('vit_ti_56_224', pretrained, progress,
                 kernel_size=56,
                 img_size=img_size, positional_embedding=positional_embedding,
                 num_classes=num_classes,
                 *args, **kwargs)
...
@register_model
def vit_ti_112_224(pretrained=False, progress=False,
               img_size=224, positional_embedding='learnable', num_classes=10,
               *args, **kwargs):
    return vit_12('vit_ti_112_224', pretrained, progress,
                 kernel_size=112,
                 img_size=img_size, positional_embedding=positional_embedding,
                 num_classes=num_classes,
                 *args, **kwargs)
